...
const EN = {
  ...
  feedback: "Feedback",
  feedbackDesc: "Share what you would like Footprint Map to help you do or a problem you encountered. Opens a third-party Tally form only when you click the button. Do not submit private photos, precise coordinates, API keys, or complete footprint files.",
  feedbackButton: "Share feedback",
  feedbackInline: "Feedback ↗",
  feedbackInlineAria: "Share feedback (opens a third-party Tally form)",
  ...
  openPhotoPreview: "Click to preview this photo",
  photoPreviewDialog: "Photo preview",
  closePhotoPreview: "Close photo preview",
  photoZoomHint: "Scroll or pinch to zoom. Drag to move the enlarged photo.",
  visit: "Place",
...
const ZH: Record<MessageKey, string> = {
  ...
  feedback: "反馈",
  feedbackDesc: "告诉我你希望 Footprint Map 帮你做什么，或者你遇到了什么问题。仅在点击按钮后打开第三方 Tally 表单；请勿提交私人照片、精确坐标、API Key 或完整足迹文件。",
  feedbackButton: "分享反馈",
  feedbackInline: "反馈 ↗",
  feedbackInlineAria: "分享反馈（打开第三方 Tally 表单）",
  ...
  openPhotoPreview: "单击查看大图",
  photoPreviewDialog: "照片大图预览",
  closePhotoPreview: "关闭照片大图预览",
  photoZoomHint: "滚动鼠标或双指捏合缩放，放大后拖动查看。",
  visit: "到访点",
