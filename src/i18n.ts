...
const EN = {
  ...
  commandExport: "Export a static footprint preview",
  ...
  noFootprintBlock: "The current note has no footprint-map code block.",
  sourceMustBeGeoJson: "source must use the .geojson extension before a static preview can be exported.",
  staticPreviewWritten: "Static preview written to {path}.",
...
const ZH: Record<MessageKey, string> = {
  ...
  noFootprintBlock: "当前笔记没有 footprint-map 代码块。",
  sourceMustBeGeoJson: "source 必须使用 .geojson 扩展名才能导出静态图。",
  staticPreviewWritten: "静态预览已写入 {path}。",
